(function($){
	function crateCommentInfo(obj){
		...
		el = el+"</div><i class='content'>"+obj.content+"</i><div class='comment-content-footer'><div class='row'><div class='col-md-10'>";
		
		if(typeof(obj.osname) != "undefined" && obj.osname != ""){
			el =el+"<span><p class='glyphicon glyphicon-pushpin' style='margin-left: 0;'></p> 来自:"+obj.osname+"</span>";
		}
